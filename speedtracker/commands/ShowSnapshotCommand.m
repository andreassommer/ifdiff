    ...
    methods
        ...
        function message = execute(~, logger, commandConfig)
            ...
            messageLines = { ...
                ...
                sprintf('Commit SHA:  %s', getOption(snapshotInfo, 'CommitSha')), ...
                sprintf('Author:      %s', getOption(snapshotInfo, 'Author')), ...
                sprintf('Date:        %s', char(datetime(str2double(getOption(snapshotInfo, 'AuthorDate')), ...
                    'ConvertFrom', 'posixtime', ...
                    'Format', 'yyyy-MM-dd HH:mm:ssZ', ...
                    'TimeZone', getOption(snapshotInfo, 'AuthorTimeZone')))), ...
                ' ', ...
                sprintf('%s', getOption(snapshotInfo, 'Subject')), ...
            };
