    ...
    methods
        ...
        function message = execute(~, logger, commandConfig)
            ...
            messageLines = { ...
                ...
                sprintf('Commit SHA:  %s', infoDict('commitSha')), ...
                sprintf('Author:      %s', infoDict('author')), ...
                sprintf('Date:        %s', char(datetime(str2double(infoDict('authorDate')), ...
                    'ConvertFrom', 'posixtime', ...
                    'Format', 'yyyy-MM-dd HH:mm:ssZ', ...
                    'TimeZone', infoDict('authorTimeZone')))), ...
                ' ', ...
                sprintf('%s', infoDict('subject')), ...
            };
