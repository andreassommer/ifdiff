...
for idxCtrlif = 1:numCtrlif
    ...
    while true
        ...
        if funcIter.new
            ...
            helperName = getExportFunctionName(switchingFunctionName, funcIter.idxMtreeCalleeExport);
            exportMtreeArray{funcIter.idxMtreeCalleeExport} = createHelperSwitchingFunction( ...
                this.functionData.mtreeArray{funcIter.idxMtreeCalleeOriginal}, ...
                helperName ...
                );
