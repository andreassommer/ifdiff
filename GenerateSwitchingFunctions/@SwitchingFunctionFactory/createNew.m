...
for idxCtrlif = 1:numCtrlif
    ...
    while true
        ...
        if funcIter.new
            ...
            helperName = getExportFunctionName(switchingFunctionName, funcIter.idxMtreeCallTargetExport);
            exportMtreeArray{funcIter.idxMtreeCallTargetExport} = createHelperSwitchingFunction( ...
                this.functionData.mtreeArray{funcIter.idxMtreeCallTargetOriginal}, ...
                helperName ...
                );
