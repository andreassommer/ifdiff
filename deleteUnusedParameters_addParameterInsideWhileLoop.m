function [mtreeObj, indexStringArray, indexArray, indexStringArrayCount] = deleteUnusedParameters_addParameterInsideWhileLoop(mtreeobj, outerLoopIndex, indexStringArray, indexArray, indexStringArrayCount)
    %
    %
    %
    %
