...
function copyAndPatchMTREEPLUS(fid_src, fid_dest)
   ...
   elseif verLessThan('MATLAB', '23.2'), copyAndPatch__generic(fid_src, fid_dest, UNTESTED);   % Version 23.2 --> 2023b
   elseif verLessThan('MATLAB', '24.2'), copyAndPatch__generic(fid_src, fid_dest, UNTESTED);   % Version 24.2 --> 2024b
   else
...
function copyAndPatch__unknown(fid_src, fid_dest, UNTESTED)
   disp('Unknown MATLAB version >9.0, trying generic method.')
