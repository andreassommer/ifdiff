...
rIndex.HEAD = mtree_rIndex_head(preprocessed.rhs{3, 1}, rIndex.HEAD);
rIndex.BODY = mtree_rIndex_function(preprocessed.rhs{3,1}, rIndex.HEAD, rIndex.BODY, config.ctrlif.functionName);
