function FDstep = generateFDstep(dim_y, dim_p, varargin)
   ...
   y_typ        = olGetOption(varargin, 'y_typ', ones(dim_y, 1));
   p_typ        = olGetOption(varargin, 'p_typ', ones(dim_p, 1));
   t_typ        = olGetOption(varargin, 't_typ', 1);
    
   hy_min       = olGetOption(varargin, 'hy_min', y_typ * 1e-10);
   hp_min       = olGetOption(varargin, 'hp_min', p_typ * 1e-10);
   ht_min       = olGetOption(varargin, 'ht_min', t_typ * 1e-10);
