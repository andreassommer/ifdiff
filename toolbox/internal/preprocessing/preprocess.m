...
% Check whether a ctrlif was added during preprocessing.
if preprocessed.ctrlif_index == 1
    msg = [ ...
        'No non-differentiable expressions found in RHS function ''%s''.\n', ...
        'Proceeding without IFDIFF code-transformation and switch-detection...\n', ...
        'Consider calling the integrator directly over IFDIFF for reduced overhead.'];
    warning('IFDIFF:Preprocessing:NoCtrlif', msg, filename);
end
end
