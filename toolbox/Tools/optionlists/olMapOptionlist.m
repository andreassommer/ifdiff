function results = olMapOptionlist(mapfn, optionlist)
    %OLMAPOPTIONLIST Apply a function to every key-value pair of an optionlist, returning a cell array of the results
