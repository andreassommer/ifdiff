...
func(2, 3) == 10 % true
    ...
    \begin{enumerate}[label=\arabic*.]
        ...
        \item You can use the provided function \lstinline|pOpt = optimizeParameters(optimizationFunc)| to setup the optimization problem and compute the optimal parameters using \lstinline|fmincon|.
