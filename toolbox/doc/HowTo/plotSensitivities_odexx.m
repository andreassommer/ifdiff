function fignum = plotSensitivities_odexx(sol, rhs, parameters, integrator, integratorOptions)
...
vdeRhs = @(t,G) VDE_RHS_y([], sol, @(dh, t, x, p) rhs(t, x, p), t, G, parameters, vdeOptions);
